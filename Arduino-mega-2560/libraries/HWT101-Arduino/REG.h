...
//寄存器的数量为128个
#define REGSIZE 0x90
#define SAVE 		0x00 //保存 重启 恢复出厂设置
#define RRATE		0x03 //发送速率
#define BAUD 		0x04 //波特率
#define IICADDR		0x1a //IIC设备地址
#define LEDOFF 		0x1b //关闭LED
#define SLEEP       0x22 //休眠
#define VERSION		0x2e //版本号
#define YYMM		0x30 //年月
#define DDHH		0x31 //日时
#define MMSS		0x32 //分秒
#define MS			0x33 //毫秒
...
#define Yaw		    0x3f //航向角
#define WORKMODE    0x48 //Z轴运行模式
#define CALIYAW     0x76 //Z轴角度归零



#define CALSW 		0x01 //校准模式
#define RSW 		0x02 //输出内容
...
//CALSW寄存器的可设置值
#define NORMAL          0x00 //正常工作模式
#define CALGYROACC      0x01 //加速度计校准
#define CALMAG          0x02 //磁场校准
#define CALALTITUDE     0x03 //高度清零
#define CALANGLEZ       0x04 //航向角清零
#define CALACCL         0x05
#define CALACCR         0x06
...
//用于设置传感器的输出内容
//RSW寄存器0x02，前10位有效，每一位都代表发送不同的内容
#define RSW_TIME 	0x01 //发送时间
#define RSW_ACC		0x02 //发送加速度
#define RSW_GYRO	0x04 //发送角速度
#define RSW_ANGLE	0x08 //发送角度
#define RSW_MAG		0x10 //发送磁场
#define RSW_PORT	0x20 //发送D口的置
#define RSW_PRESS	0x40 //发送发送气压
#define RSW_GPS		0x80 //发送GPS
#define RSW_V       0x100 //发送地速
#define RSW_Q       0x200 //发送四元数
#define	RSW_GSA		0x400 //发送GSA
#define RSW_MASK	0xfff  //全部置1不知道是发送什么
//发送速率相关的宏定义
//RRATE寄存器0x03，只有后四位有效
