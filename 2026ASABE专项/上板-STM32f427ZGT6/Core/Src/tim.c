...
{
    TCM_RegisterTimerHandle(TIMER_2, &htim2);
    TCM_RegisterTimerHandle(TIMER_3, &htim3);
    TCM_RegisterTimerHandle(TIMER_4, &htim4);
    TCM_RegisterTimerHandle(TIMER_8, &htim8);
    TCM_RegisterTimerHandle(TIMER_9, &htim9);
}
